...
public class PageTest
{
	...
	{
		Page page1 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{1,1,1,1});
	...
	{
		Page page1 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{1,1,1,1});
		Page page2 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{1,1,1,1});
	...
	{
		Page page1 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{1,1,1,1});
		Page page2 = new Page(new PageId(2, new TableId("aaaaaa.txt")), new byte[]{1,1,1,1});
	...
	{
		Page page1 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{1,1,1,1});
		Page page2 = new Page(new PageId(1, new TableId("a.txt")), new byte[]{2,2,2,2,2,2,2,2,2,2});
		assertFalse(page1.equals(page2));
	}
}
