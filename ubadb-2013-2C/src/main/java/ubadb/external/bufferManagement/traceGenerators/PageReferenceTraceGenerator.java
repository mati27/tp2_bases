...
{
	protected List<PageId> generateSequentialPages(String fileName, int from, int to)
	{
	...
	protected List<PageId> generateRandomPages(String fileName, int pageCount, int fileTotalPagesCount)
	{
		List<PageId> ret = new ArrayList<>();
